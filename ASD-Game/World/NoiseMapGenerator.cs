...
namespace ASD_Game.World
{
    public class NoiseMapGenerator : INoiseMapGenerator
    {
        ...
        public NoiseMapGenerator(int seed, IItemService itemService, IEnemySpawner enemySpawner, List<ItemSpawnDTO> items, List<Monster> monsters, IGameConfigurationHandler gameConfigurationHandler, int monsterSpawnChance = 5)
        {
